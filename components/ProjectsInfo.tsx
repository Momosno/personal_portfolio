...
export default function ProjectsInfo({ project }: { project: Project }) {
    return (
        <>
            {/* Mobile */}
            <div className=" md:hidden absolute top-0 left-0 pt-4 pl-12 pr-5 pb-12 w-full h-full flex justify-center items-center">
                {/* Contenedor General */}
                <div className="h-full w-full flex flex-col gap-6  text-center justify-center items-center">
                    ...
                    {/* Texto */}
                    <div className="w-full  flex flex-col justify-between  bg-black/50 rounded-xl p-2">
                        <div className="w-full font-montserrat text-sm  flex flex-col justify-between h-full">
                            <div className="flex flex-col gap-0.5">
                                <hr className="border" />
                                <h3 className="font-nunito font-bold  text-base">{project.name}</h3>
                                <hr className="border" />
                            </div>
